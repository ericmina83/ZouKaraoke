...
from PyQt5.QtWidgets import QWidget, QPushButton, QLineEdit, QHBoxLayout, QVBoxLayout, QLabel, QListView, QComboBox
...
class NewSongInfoForm(QWidget):
    def __init__(self):
        ...
        self.songLangComboBox.addItems(
    ...
    def check_song_correct_or_not(self, version: SongVersion):
        ...
        currentSingerType = list(SingerType)[
            self.singerTypeComboBox.currentIndex()]
    ...
    def check_singer_correct_or_not(self, singer: Singer):
        ...
        if currentSingerType is not singer.singerType and currentSingerType is not SingerType.NONE:
            return False
    ...
    def check_every_singers_correct_or_not(self):
        ...
        self.singers = list(
            filter(self.check_singer_correct_or_not, singers))
